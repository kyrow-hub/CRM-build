...
export async function getDashboardStats() {
  ...
  const [clientsResult, leadsResult, referralsWeekResult, meetingsWeekResult] = await Promise.all([
  ...
  for (const result of [clientsResult, leadsResult, referralsWeekResult, meetingsWeekResult]) {
