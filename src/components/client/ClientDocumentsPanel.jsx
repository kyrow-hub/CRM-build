...
export default function ClientDocumentsPanel({ clientId, clientName }) {
  ...
  return (
    <div>
      ...
      <Card style={!loading && documents.length === 0 ? undefined : { padding: 0 }}>
        {loading ? (
          <EmptyState icon={Folder} title="Loading documents..." text="Fetching documents for this client." />
        ) : error ? (
          ...
          <EmptyState
            ...
            text="Files and documents related to this client will appear here. Max 20 MB per file."
          />
        ) : (
